                            ...
                            <div class="pin-wrapper">
                                ...
                                <ul class="nav nav-list mb-xl show-bg-active">
                                    ...
                                    <li><a data-hash="" data-hash-offset="0"
                                            href="<?= site_url('maintenances/') ?><?= $maintenance->link_maintenance ?>"><?= $maintenance->nama_maintenance ?></a>
                                    </li>
                                    <?php
                                    }
                                    ?>
                    ...
                    <div class="col-md-9">
                        ...
                        <div class="container">
                            <div class="row">
                                <div class="col-md-12">
                                    <?php
                                    $datamaintenance=$this->db->get_where($table,['link_maintenance'=>$slug])->row();

                                    ?>
                                    <h1><?= $datamaintenance->nama_maintenance ?></h1>
                                    <hr>
                                    <p>
                                    <?= $datamaintenance->deskripsi_maintenance ?>
                                    </p>
                                </div>
                            </div>
                        </div>
