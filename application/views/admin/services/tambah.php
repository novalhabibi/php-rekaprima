...
<div class="row">
    ...
    <!-- validation form -->
        <div class="card">
            ...
            <div class="card-body">
                <form class="needs-validation" novalidate enctype="multipart/form-data" action="<?= site_url('dashboard/service/tambah') ?>" method="post">
                    <div class="row">
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 ">
                            <label for="validationCustom01">Nama Service</label>
                            <input type="text" name="nama_service" class="form-control" id="validationCustom01" required>
                        ...
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 ">
                            ...
                            <input type="file" name="gambar_service" accept="image/*" class="form-control" id="validationCustom03" required>
                            <div class="valid-feedback"><i class="fas fa-info-circle"></i>
                                Bagus! 
                            </div>
                            <div class="invalid-feedback"><i class="fas fa-exclamation-triangle"></i> Jangan biarkan kososng !
