...
<div class="row">
    ...
    <!-- validation form -->
        <div class="card">
            ...
            <div class="card-body">
                <form class="needs-validation" novalidate enctype="multipart/form-data" action="<?= site_url('dashboard/news/tambah') ?>" method="post">
                    <div class="row">
                        ...
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 ">
                            ...
                            <textarea name="deskripsi" class="form-control" id="ckeditor" required cols="5" rows="5"></textarea>
                            <div class="valid-feedback"><i class="fas fa-info-circle"></i>
                                Bagus! 
                            </div>
                            <div class="invalid-feedback"><i class="fas fa-exclamation-triangle"></i> Jangan biarkan kososng !
