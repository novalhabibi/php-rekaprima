            ...
            <div class="dashboard-ecommerce">
                ...
                <div class="row">
                    ...
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="card">
                            <h5 class="card-header">Data maintenance
                                <div class="float-right">
                                    
                                    <a href="<?= site_url('dashboard/maintenance/tambah') ?>" class="btn btn-primary btn-xs">
...
<a href="<?= base_url() ?><?= $maintenance->gambar_maintenance ?>" data-toggle="lightbox" data-title="<?= $maintenance->nama_maintenance ?>" data-footer="">Lihat gambar</a>
                                                ...
                                                <td>
                                                    <a href="<?= site_url("dashboard/maintenance/edit/$maintenance->id_maintenance") ?>" class="btn btn-primary btn-xs">
                                                        <i class="fas fa-pencil-alt"></i>
                                                    </a>
                                                    <a href="#" onclick="deleteConfirm('<?= site_url('maintenance/hapus/'.$maintenance->id_maintenance) ?>')" data-toggle="modal" data-target="#hapus" class="btn btn-danger btn-xs">
