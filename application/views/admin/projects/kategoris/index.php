...
<div class="row">
    ...
    <!-- validation form -->
        <div class="card">
            <h5 class="card-header">Tambah Kategori Projek</h5>
            <div class="card-body">
                <form class="needs-validation" novalidate action="<?= site_url('projek/kategori/simpan') ?>" method="post">
                    <div class="row">
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 ">
                            <label for="validationCustom01">Nama Kategori Projek</label>
                            <input type="text" name="nama_kategori_project" class="form-control" id="validationCustom01" required>
