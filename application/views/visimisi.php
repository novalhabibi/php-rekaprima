...
<!-- header -->
  ...
  <!-- end header -->
        <div class="main" role="main">
                ...
                <section class="page-header page-header-custom-background" style="background-image:url(<?php echo base_url('assets/media/image/visionmission.jpg') ?>);height:250px;">
                        ...
                        <div class="col-md-12">
                            <div class="row">
                                <div class="col-md-12 col-lg-12">
                                    ...
                                    <p style="text-align: center;">Menjadi Perusahaan Operator & Maintenance Perkeretaapian Nasional yang Handal di Tahnun 2022</p>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-12 col-lg-12">
