                    ...
                    <div class="col-md-12">
                        ...
                        <div class="row">
                            <div class="row">
                                ...
                                <div class="row">
                                    <?php
                                    $managements=$this->db->get('manajemen')->result();
                                    foreach ($managements as $manajemen) {
                                      
                                    ?>
                                    <div class="col-md-4 col-sm-6"><a href="#<?= $manajemen->id_manajemen ?>"
                                            class="popup-with-zoom-anim"> <span class="thumb-info"> <span
                                                    class="thumb-info-wrapper"> <img
                                                        src="<?= site_url() ?><?= $manajemen->gambar_manajemen ?>"
                                                        class="img-responsive" caption="false" width="350"
                                                        height="400" /> <span class="thumb-info-title"> <span
                                                            class="thumb-info-inner"><?= $manajemen->nama_manajemen ?></span> <span
                                                            class="thumb-info-type"><?= $manajemen->posisi_manajemen ?></span>
                                                    </span> <span class="thumb-info-action"> <span
                                                            class="thumb-info-action-icon"> <i class="fa fa-link"></i>
                                                        </span> </span> </span> </span> </a>
                                                        
                                        <div id="<?= $manajemen->id_manajemen ?>"
                                            class="dialog dialog-lg zoom-anim-dialog mfp-hide p-xlg">
                                            <div class="row">
                                                <div class="col-md-4 col-sm-4"><img class="img-responsive mb-lg"
                                                        src="<?= site_url() ?><?= $manajemen->gambar_manajemen ?>"
                                                        caption="false" width="350" height="400" /></div>
                                                <div class="col-md-8 col-sm-8">
                                                    <h2 class="mb-none"><?= $manajemen->nama_manajemen ?></h2>
                                                    <h4 class="heading-primary"><?= $manajemen->posisi_manajemen ?></h4>
                                                    <p class="font-size-sm custom-line-height-1"
                                                        style="text-align: justify;">
                                                        <?= $manajemen->profile_manajemen ?>    
                                                    </p>
