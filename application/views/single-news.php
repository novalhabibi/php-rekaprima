                ...
                <div class="row">
                        ...
                        <div class="blog-post single-post">
                            <article class="post blog-single-post">
                                        ...
                                        <div>
                                            <div class="img-thumbnail">
                                                <img class="img-responsive"
                                                    src="<?= site_url() ?><?= $berita->gambar ?>" alt="">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="">
                                    ...
                                    <div class="post-meta">
                                        <span><i class="fa fa-calendar"> <?= $berita->tgl_posting ?></i></span>
                                        <span><i class="fa fa-user"> By <?= $berita->nama_admin ?></i></span>
                    ...
                    <div class="col-md-3">
                        <aside class="siderbar">
                            <h4 class="heading-primary">Hight Light</h4>
                            <ul class="nav nav-list mb-xlg">
                                <?php
                                foreach ($news as $hl) {
                                 
                                ?>
                                <li><a href="<?= site_url('news/') ?><?= $hl->slug ?>"><?= $hl->judul ?></a></li>
                                <?php
                                }
                                ?>
                            </ul>
