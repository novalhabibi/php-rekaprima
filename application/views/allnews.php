                        ...
                        <div class="blog-posts">
                            ...
                            <article class="post post-medium">
                                <div class="row">
                                    <div class="col-md-5">
                                        <div class="post-image">
                                            <img src="<?= site_url() ?><?= $berita->gambar ?>" alt=""
                                    ...
                                    <div class="col-md-7">
                                        ...
                                        <div class="post-content">
                                            ...
                                            <h4><a
                                                    href="<?= site_url('news/') ?><?= $berita->slug ?>">Sinergi
                                                    <?= $berita->judul ?></a></h4>
                                            <p></p>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="post-meta">
                                            <span><i class="fa fa-calendar"></i> <?= $berita->tgl_posting ?> </span>
                                            <a href="<?= site_url('news/') ?><?= $berita->slug ?>"
