...
<!-- header -->
  ...
  <!-- end header -->
        ...
        <div class="main" role="main">
                ...
                <section class="page-header page-header-custom-background" style="background-image:url(<?php echo base_url('assets/media/image/sejarah.jpg') ?>);height:250px;">
                        ...
                        <div class="col-md-12">
                            <ul class="history">
                                <li class="appear-animation animated fadeInUp appear-animation-visible" data-appear-animation="fadeInUp">
                                    <div class="featured-box" style="margin-left: 0px;">
                                        <div class="box-content">
                                            <h4 class="heading-primary"><strong>1957</strong></h4>
                                ...
                                <li class="appear-animation animated fadeInUp appear-animation-visible" data-appear-animation="fadeInUp">
                                    <div class="featured-box" style="margin-left: 0px;">
                                        <div class="box-content">
                                            <h4 class="heading-primary"><strong>1971</strong></h4>
                                            <p>Selanjutnya, melalui UU No.8 tahun 1971, pemerintah mengatur peran Pertamina untuk menghasilkan dan mengolah migas dari ladang-ladang minyak serta menyediakan kebutuhan bahan bakar dan gas di Indonesia. Kemudian melalui UU No.22 tahun 2001, pemerintah mengubah kedudukan Pertamina sehingga penyelenggaraan Public Service Obligation (PSO) dilakukan melalui kegiatan usaha.</p>
                                        </div>
                                    </div>
                                </li>
                                <li class="appear-animation animated fadeInUp appear-animation-visible" data-appear-animation="fadeInUp">
                                    <div class="featured-box" style="margin-left: 0px;">
                                        <div class="box-content">
                                            <h4 class="heading-primary"><strong>2003</strong></h4>
                                            <p>Berdasarkan PP No.31 Tahun 2003 tanggal 18 Juni 2003, Perusahaan Pertambangan Minyak dan Gas Bumi Negara berubah nama menjadi PT Pertamina (Persero) yang melakukan kegiatan usaha migas pada Sektor Hulu hingga Sektor Hilir. Pada 10 Desember 2005, Pertamina mengubah lambang kuda laut menjadi anak panah dengan warna dasar hijau, biru, dan merah yang merefleksikan unsur dinamis dan kepedulian lingkungan.</p>
                                        </div>
                                    </div>
                                </li>
                                <li class="appear-animation animated fadeInUp appear-animation-visible" data-appear-animation="fadeInUp">
                                ...
                                <li class="appear-animation animated fadeInUp appear-animation-visible" data-appear-animation="fadeInUp">
                                    <div class="featured-box" style="margin-left: 0px;">
                                        <div class="box-content">
                                            ...
                                            <p>Pada 14 Desember 2015, Menteri BUMN selaku RUPS menyetujui perubahan Anggaran Dasar Pertamina dalam hal optimalisasi pemanfaatan sumber daya, peningkatan modal ditempatkan dan diambil bagian oleh negara serta perbuatan-perbuatan Direksi yang memerlukan persetujuan tertulis Dewan Komisaris. Perubahan ini telah dinyatakan pada Akta No.10 tanggal 11 Januari 2016, Notaris Lenny Janis Ishak, SH.</p>
                                        </div>
                                    </div>
                                </li>
                                <li class="appear-animation animated fadeInUp appear-animation-visible" data-appear-animation="fadeInUp">
                                    <div class="featured-box" style="margin-left: 0px;">
                                        <div class="box-content">
                                            ...
                                            <p>Pada 24 November 2016, Menteri BUMN selaku RUPS sesuai dengan SK BUMN No. S-690/MBU/11/2016, menyetujui perubahan Anggaran Dasar Pertamina terkait dengan komposisi Direksi dan Dewan Komisaris, kewenangan atas nama Direktur Utama, pembagian tugas dan wewenang Direksi, kehadiran rapat Direktur Utama dan Dewan Komisaris.</p>
                                        </div>
                                    </div>
                                </li>
                            </ul>
